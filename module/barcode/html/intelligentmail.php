...
<ul id="specificOptions">
    <li class="option">
        ...
        <div class="value">
            <?php echo getInputTextHtml('barcodeIdentifier', $barcodeIdentifier, array('type' => 'text', 'maxlength' => 2)); ?>
        </div>
    </li>
    <li class="option">
        <div class="title">
        ...
        <div class="value">
            <?php echo getInputTextHtml('serviceType', $serviceType, array('type' => 'text', 'maxlength' => 3)); ?>
        </div>
    </li>
    <li class="option">
        <div class="title">
        ...
        <div class="value">
            <?php echo getInputTextHtml('mailerIdentifier', $mailerIdentifier, array('type' => 'text', 'maxlength' => 9)); ?>
        </div>
    </li>
    <li class="option">
        <div class="title">
        ...
        <div class="value">
            <?php echo getInputTextHtml('serialNumber', $serialNumber, array('type' => 'text', 'maxlength' => 9)); ?>
        </div>
    </li>
</ul>
