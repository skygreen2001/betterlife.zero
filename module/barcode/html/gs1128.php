...
$default_value['setStart'] = 'C';
$setStart = isset($_POST['setStart']) ? $_POST['setStart'] : $default_value['setStart'];
registerImageKey('setStart', $setStart);
...
<ul id="specificOptions">
    <li class="option">
        <div class="title">
            <label for="setStart">Starts with</label>
        </div>
        <div class="value">
            <?php echo getSelectHtml('setStart', $setStart, array('NULL' => 'Auto', 'A' => 'Code 128-A', 'B' => 'Code 128-B', 'C' => 'Code 128-C')); ?>
        </div>
    </li>
    <li class="option">
        <div class="title">
