...
class UtilKindEditor extends Util
{
    ...
    {
        UtilCss::loadCssReady($viewObject,"misc/js/onlineditor/kindeditor/themes/default/default.css");
        if (UtilAjax::$IsDebug){
            UtilJavascript::loadJsReady($viewObject, "misc/js/onlineditor/kindeditor/kindeditor.js");
        }else{
            UtilJavascript::loadJsReady($viewObject, "misc/js/onlineditor/kindeditor/kindeditor-min.js");
        }

        UtilJavascript::loadJsReady($viewObject, "misc/js/onlineditor/kindeditor/lang/zh_CN.js");
