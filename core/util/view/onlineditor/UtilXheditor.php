...
{                       
	 ...
	 * @param string form_id  在线编辑器所在的Form的ID                 
	 */
	private static function loadJsFunction($viewObject=null,$form_id=null)
	{        
		$shortcut="";
		$formsubmit="";
		if (!empty($form_id)){
		...
		UtilJavascript::loadJsContentReady($viewObject,"
			...
			function pageInit(textarea_id)
			{
				...
				xhEditor=$('#'+textarea_id).xheditor({inlineStyle:false,showBlocktag:true,upLinkUrl:'".Gc::$url_base."common/js/onlineditor/xheditor/demos/upload.php?immediate=1',upImgUrl:'".Gc::$url_base."common/js/onlineditor/xheditor/demos/upload.php?immediate=1',upFlashUrl:'".Gc::$url_base."common/js/onlineditor/xheditor/common/js/onlineditor/xheditor/demos/upload.php?immediate=1',upMediaUrl:'".Gc::$url_base."common/js/onlineditor/xheditor/demos/upload.php?immediate=1',localUrlTest:/^https?:\/\/[^\/]*?(xheditor\.com)\//i,remoteImgSaveUrl:'".Gc::$url_base."common/js/onlineditor/xheditor/demos/saveremoteimg.php',emots:{
	...
	public static function loadXheditorCssAndJsFunction($viewObject=null,$form_id=null)
	{
		self::loadcss($viewObject);
		UtilJavascript::loadJsReady($viewObject, "common/js/onlineditor/xheditor/xheditor-1.1.13-zh-cn.min.js"); 
		self::loadJsFunction($viewObject); 
	}
}   
?>
