...
{            
	...
	public static function AutoCode()
	{
		...
		echo "<font color='#00FF00'>/***********************************生成Action类[增删改查模板、前端和后端]:start********************************************</font><br/>";
		//生成Action类[前端和后端]
		...
		AutoCodeAction::AutoCode();   
		echo "<font color='#00FF00'>/***********************************生成Action类[增删改查模板、前端和后端]:end  ********************************************</font><br/><br/>";
							   
		echo "<font color='#00FF00'>/***********************************生成增删改查模板、前端表示层:start********************************************</font><br/>"; 
		//生成前端表示层
		...
		AutoCodeViewDefault::AutoCode();  
		echo "<font color='#00FF00'>/***********************************生成增删改查模板、前端表示层:end  ********************************************</font><br/><br/>";
