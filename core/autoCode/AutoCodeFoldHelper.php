...
function show_showdiv(){
    if (document.getElementById("Content_1"))document.getElementById("Content_1").style.display='block';
    if (document.getElementById("Content_2"))document.getElementById("Content_2").style.display='block';
    if (document.getElementById("Content_3"))document.getElementById("Content_3").style.display='block';
    if (document.getElementById("Content_4"))document.getElementById("Content_4").style.display='block';
    if (document.getElementById("Content_5"))document.getElementById("Content_5").style.display='block';        
    if (document.getElementById("Content_11"))document.getElementById("Content_11").style.display='block';
    if (document.getElementById("Content_12"))document.getElementById("Content_12").style.display='block';
    if (document.getElementById("Content_21"))document.getElementById("Content_21").style.display='block';
    if (document.getElementById("Content_22"))document.getElementById("Content_22").style.display='block';
    if (document.getElementById("Content_23"))document.getElementById("Content_23").style.display='block';
    if (document.getElementById("Content_31"))document.getElementById("Content_31").style.display='block';
    if (document.getElementById("Content_32"))document.getElementById("Content_32").style.display='block';
    if (document.getElementById("Content_41"))document.getElementById("Content_41").style.display='block';
    if (document.getElementById("Content_42"))document.getElementById("Content_42").style.display='block';
    if (document.getElementById("Content_51"))document.getElementById("Content_51").style.display='block';
    if (document.getElementById("Content_52"))document.getElementById("Content_52").style.display='block';
    if (document.getElementById("Content_53"))document.getElementById("Content_53").style.display='block';
}
<!--收起函数-->
function hidden_hiddendiv(){
    ...
    if (document.getElementById("Content_4"))document.getElementById("Content_4").style.display='block';
    if (document.getElementById("Content_5"))document.getElementById("Content_5").style.display='block';
    if (document.getElementById("Content_11"))document.getElementById("Content_11").style.display='none';
    if (document.getElementById("Content_12"))document.getElementById("Content_12").style.display='none';
    if (document.getElementById("Content_21"))document.getElementById("Content_21").style.display='none';
    if (document.getElementById("Content_22"))document.getElementById("Content_22").style.display='none';
    if (document.getElementById("Content_23"))document.getElementById("Content_23").style.display='none';
    if (document.getElementById("Content_31"))document.getElementById("Content_31").style.display='none';
    if (document.getElementById("Content_32"))document.getElementById("Content_32").style.display='none';
    if (document.getElementById("Content_41"))document.getElementById("Content_41").style.display='none';
    if (document.getElementById("Content_42"))document.getElementById("Content_42").style.display='none';
    if (document.getElementById("Content_51"))document.getElementById("Content_51").style.display='none';
    if (document.getElementById("Content_52"))document.getElementById("Content_52").style.display='none';
    if (document.getElementById("Content_53"))document.getElementById("Content_53").style.display='none';
}
</script>
<span>&nbsp;</span>
