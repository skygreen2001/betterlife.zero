				...
				bbar: new Ext.PagingToolbar({
					...
					listeners:{
						change:function(thisbar,pagedata){
							if ($appName_alias.$classname.Viewport){
...
{$textareaOnlineditor_Add}{$treeLevelVisible_Add}{$password_Add}
