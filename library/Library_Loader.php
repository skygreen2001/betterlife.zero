...
class Library_Loader
{
    ...
    {
        $dir_library_phpunit="PHPUnit".DS;
    ...
    private static function load_template()
    {
        switch (Gc::$template_mode) {
           case View::TEMPLATE_MODE_SMARTY:
             ...
             break;
           case View::TEMPLATE_MODE_SMARTTEMPLATE:
                self::load_template_smartytemplate();
             break;
           case View::TEMPLATE_MODE_EASETEMPLATE:
                self::load_template_easetemplate();
             break;
           case View::TEMPLATE_MODE_TEMPLATELITE:
                self::load_template_templatelite();
             break;
           case View::TEMPLATE_MODE_FLEXY:
    ...
    */
    private static function load_template_flexy()
    {
        ...
        set_include_path(get_include_path().PATH_SEPARATOR.self::dir_library().self::DIR_TEMPLATE.DS.$dir_template_flexy);
        $sub_dir_flexy="HTML/Template";
        require_once self::dir_library().self::DIR_TEMPLATE.DS.$dir_template_flexy.DS.$sub_dir_flexy.DS.$file_template_smarty;
    ...
    */
    ...
    {
        require_once self::dir_library()."yaml".DS."spyc.php";
    }
