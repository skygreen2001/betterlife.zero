...
function et($tag){
    ...
    $zh['File'] = '文件';
    $zh['File_s'] = 'file(s)';
    $zh['Dir_s'] = 'directory(s)';
    $zh['To'] = 'to';
    $zh['Destination'] = '目的地';
    $zh['Configurations'] = 'Configurations';
    $zh['JSError'] = 'JavaScript Error';
    $zh['NoSel'] = 'There are no selected itens';
    $zh['SelDir'] = 'Select the destination directory on the left tree';
    $zh['TypeDir'] = 'Enter the directory name';
    $zh['TypeArq'] = 'Enter the file name';
    $zh['TypeCmd'] = 'Enter the command';
    $zh['TypeArqComp'] = 'Enter the file name.\\nThe extension will define the compression type.\\nEx:\\nnome.zip\\nnome.tar\\nnome.bzip\\nnome.gzip';
    $zh['RemSel'] = 'DELETE selected itens';
    ...
    $zh['ConfExec'] = 'Confirm EXECUTE';
    $zh['ConfRem'] = 'Confirm DELETE';
    $zh['EmptyDir'] = 'Empty directory';
    $zh['IOError'] = 'I/O Error';
    $zh['FileMan'] = 'PHP File Manager';
    $zh['TypePass'] = 'Enter the password';
    $zh['InvPass'] = 'Invalid Password';
    $zh['ReadDenied'] = 'Read Access Denied';
    $zh['FileNotFound'] = 'File not found';
    $zh['AutoClose'] = 'Close on Complete';
    $zh['OutDocRoot'] = 'File beyond DOCUMENT_ROOT';
    $zh['NoCmd'] = 'Error: Command not informed';
    $zh['ConfTrySave'] = 'File without write permisson.\\nTry to save anyway';
    $zh['ConfSaved'] = 'Configurations saved';
    $zh['PassSaved'] = 'Password saved';
    ...
    $zh['ChkVer'] = 'Check sf.net for new version';
    $zh['ChkVerAvailable'] = 'New version, click here to begin download!!';
    $zh['ChkVerNotAvailable'] = 'No new version available. :(';
    $zh['ChkVerError'] = 'Connection Error.';
    $zh['Website'] = 'Website';
    $zh['SendingForm'] = 'Sending files, please wait';
    $zh['NoFileSel'] = 'No file selected';
    $zh['SelAll'] = '所有';
    $zh['SelNone'] = 'None';
    $zh['SelInverse'] = '反选';
    $zh['Selected_s'] = 'selected';
    $zh['Total'] = 'total';
    $zh['Partition'] = 'Partition';
    $zh['RenderTime'] = 'Time to render this page';
    $zh['Seconds'] = 'sec';
    $zh['ErrorReport'] = 'Error Reporting';
