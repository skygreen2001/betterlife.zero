...
/*- img-end -*/
        ...
        class_exists("Gc")||require(dirname(__FILE__)."/../../Gc.php");
        $url_root=Gc::$url_base;
...
<a href="$url_root" target="_blank" style="color:#fff;font-size:12px">BetterLife&copy;2010</a>
</center>
 </body>
</html>
EOF;
