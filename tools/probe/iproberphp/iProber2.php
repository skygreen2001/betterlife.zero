...
<form method="post" action="<?=PHPSELF."#bottom"?>"  id="main_form">
	<div id="top">
		...
		<a name="top"></a>
		<p id="t1"><a href="http://depoch.net/download.htm" target="_blank">点击下载 iProber 探针, 或查看最新版本 ■</a><br />
			<a href="mailto:depoch@gmail.com">报告BUGS, 或反馈意见给 dEpoch Studio ■</a></p>
		<div id="t2">
			<ul>
				<li id="t21"><a href="#sec1">服务器特征</a><a href="#sec2">PHP基本特征</a><a href="#sec3">PHP组件支持状况</a><a href="#sec4">服务器性能检测</a><a href="#sec5">自定义检测</a></li>
