...
class XMLSchema {
	...
	public function addComplexType($type,$name=false,$parent=false){
		//$this->addToDebug("Adding complexType '$name':'$type'");
...
//				$this->addToDebug("&nbsp;&nbsp;&nbsp;complexType is a stdClass");
...
//						$this->addToDebug("&nbsp;&nbsp;&nbsp;Adding property '$keyType' of type '$valueType' to class '$name'");
...
//				$this->addToDebug("&nbsp;&nbsp;complexType is a known class '$name'");
...
//						$this->addToDebug("&nbsp;&nbsp;&nbsp;Adding property '$prName' of type '".$property->type."' to class '$name'");
...
//		$this->addToDebug("Adding Array '$type'");
