...
<div class="block">
    ...
    <table class="viewdoblock">
        <tr class="entry"><td class="head">标识</th><td class="content">{$usernotice.usernotice_id}</td></tr> 
        <tr class="entry"><td class="head">用户编号</th><td class="content">{$usernotice.user_id}</td></tr> 
        <tr class="entry"><td class="head">通知编号</th><td class="content">{$usernotice.notice_id}</td></tr> 
    </table>
