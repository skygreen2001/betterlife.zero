...
<div class="block">
    ...
    <table class="viewdoblock">
        <tr class="entry"><td class="head">用户标识</th><td class="content">{$user.user_id}</td></tr> 
        ...
        <tr class="entry"><td class="head">手机电话</th><td class="content">{$user.cellphone}</td></tr> 
        <tr class="entry"><td class="head">访问次数</th><td class="content">{$user.loginTimes}</td></tr> 
    </table>
