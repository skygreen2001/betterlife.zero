...
<div class="block">  
	...
	<table class="viewdoblock">   
        <tr class="entry"><td class="head">部门名称</th><td class="content">{$department.name}</td></tr> 
        ...
        <tr class="entry"><td class="head">部门人员预估平均工资</th><td class="content">{$department.estsalary}</td></tr> 
        <tr class="entry"><td class="head">部门人员实际平均工资</th><td class="content">{$department.actualsalary}</td></tr>          
	</table>                                                            
