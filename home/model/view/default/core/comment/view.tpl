...
<div class="block">
    ...
    <table class="viewdoblock">
        <tr class="entry"><td class="head">标识</th><td class="content">{$comment.comment_id}</td></tr> 
        <tr class="entry"><td class="head">评论者标识</th><td class="content">{$comment.user_id}</td></tr> 
        <tr class="entry"><td class="head">评论</th><td class="content">{$comment.comment}</td></tr> 
        <tr class="entry"><td class="head">博客标识</th><td class="content">{$comment.blog_id}</td></tr> 
    </table>
