...
<div class="block">  
	...
	<table class="viewdoblock">   
        <tr class="entry"><td class="head">标识</th><td class="content">{$logsystem.logsystem_id}</td></tr> 
	...
	<div align="center"><my:a href='index.php?go=model.logsystem.lists&pageNo={$smarty.get.pageNo|default:"1"}'>返回列表</my:a>|<my:a href='index.php?go=model.logsystem.edit&id={$logsystem.id}&pageNo={$smarty.get.pageNo|default:"1"}'>修改系统日志</my:a></div>    
</div>
{/block}