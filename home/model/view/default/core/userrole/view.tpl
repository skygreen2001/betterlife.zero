...
<div class="block">  
	...
	<table class="viewdoblock">   
        <tr class="entry"><td class="head">标识</th><td class="content">{$userrole.userrole_id}</td></tr> 
        <tr class="entry"><td class="head">用户标识</th><td class="content">{$userrole.user_id}</td></tr> 
        <tr class="entry"><td class="head">角色标识</th><td class="content">{$userrole.role_id}</td></tr>          
	</table>                                                            
