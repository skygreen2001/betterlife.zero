...
<div class="block">
    ...
    <table class="viewdoblock">
        ...
        <tr class="entry"><td class="head">博客标题</th><td class="content">{$blog.blog_name}</td></tr> 
        <tr class="entry"><td class="head">博客内容</th><td class="content">{$blog.blog_content}</td></tr> 
    </table>
