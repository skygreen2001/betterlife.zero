...
{block name=body}
 ...
 <div class="block">
    ...
    <div align="center"><my:a href='{$url_base}index.php?go=model.comment.lists&pageNo={$smarty.get.pageNo|default:"1"}'>返回列表</my:a>{if $comment}|<my:a href='{$url_base}index.php?go=model.comment.view&id={$comment.id}&pageNo={$smarty.get.pageNo|default:"1"}'>查看评论</my:a>{/if}</div>
