...
{block name=body}
 <div class="block">
	...
	<div align="center"><my:a href='{$url_base}index.php?go=model.userrole.lists&pageNo={$smarty.get.pageNo|default:"1"}'>返回列表</my:a>{if $userrole}|<my:a href='{$url_base}index.php?go=model.userrole.view&id={$userrole.id}&pageNo={$smarty.get.pageNo|default:"1"}'>查看用户角色</my:a>{/if}</div>
</div>
{/block}