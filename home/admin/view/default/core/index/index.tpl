    ...
    <div id="header" class='x-hide-display'>
        <table>
            ...
            <tr>
                ...
                <td><span style="float:right; font-size: 16px; margin-top: 15px;margin-right: 10px;color: #CCC"><a href="http://blog.sina.com.cn/u/1564252780" target="_blank" style="padding:5px">新浪</a>|<a href="http://hi.csdn.net/skygreen_2001" style="padding:5px" target="_blank">CSDN</a></span></td>
            </tr>
        </table>
    </div>
