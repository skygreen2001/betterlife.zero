	...
	* @param id 添加的Tab的标识
	*/
	bb.Navigation.addTabByUrl=function(contentPanel,title,url,id)
	{
		var cpId = 'cp-' + id;
	...
	*/
	bb.Navigation.HyperlinkClicked=function(e)
	{
		e.preventDefault();
		...
		bb.Navigation.addTabByUrl(Ext.getCmp('centerPanel'),title,linkTarget.href,linkTarget.id);
	}
