...
Bb.Layout = {    
	 ...
	 */
	HeaderPanel : [{
		region:'north',contentEl:'header',id:'header-panel',ref:'head',
		header:false,collapsible:true,collapseMode : 'mini',split : true,height:27*3,
		tbar:{
	 ...
	 */
	LeftPanel : [{
		region : 'west',ref:'west',id : 'west-panel', // see Ext.getCmp() below
		title : '功能区',collapseMode : 'mini',
